...
console.log("I am doing lab-04 walkthrough");
/**
...
//  ↓ YOUR CODE HERE ↓
console.log(availableFlightSeet - 2);
...
console.log(
  "I bought a candy bar. The grocery total is now: " + (costOfGroceries + 2.15)
);
...
console.log("Summer arrived, it's July now ... isHotOutside = " + isHotOutside);
...
var fullName = firstName + " " + middleInitial + " " + "Zahra";
...
console.log(
  "Here is your new  customer! Her name is: " +
    fullName +
    ". " +
    "She lives at " +
    streetAddress
